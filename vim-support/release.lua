...
--------------------------------------------------------------------------------
--         FILE:  release.lua
--        USAGE:  lua vim-support/release.lua <mode> [<options>]
...
elseif args[1] == 'cp-repo' then
	...
	if #args >= 2 then
		...
		os.execute ( 'mkdir -p '..args[2]..'/project' )
		...
		if success then
			cmd = 'cat vim-support/README.standalone.md vim-support/README.md > '..args[2]..'/README.md'
