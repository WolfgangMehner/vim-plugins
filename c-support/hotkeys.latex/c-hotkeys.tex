...
%%    Copyright:  Copyright (C) 2006-2013  Dr.-Ing. Fritz Mehner (mehner@fh-swf.de)
%%      Version:  1.0
%%      Created:  10.11.2006
%%                
%%        Notes:  
...
%
Set command line arguments for \texttt{make} (same as \textbackslash\texttt{rma})\\[1.0ex]
\texttt{ :CMakeCmdlineArgs}\\[1.0ex]
%
