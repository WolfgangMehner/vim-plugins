...
%%      Copyright:  Copyright (c) 2006-2014, Dr. Fritz Mehner
%%
%%          Notes:  
%%                
%%=====================================================================================
...
%
\newcommand{\Pluginversion}{6.2pre}
...
\hypersetup{pdfauthor={Dr.-Ing. Fritz Mehner, Germany, mehner.fritz@web.de}}
...
{\tiny Plug-in: http://vim.sourceforge.net / Fritz Mehner (mehner.fritz@web.de)}\\
\vspace{1.0mm}
