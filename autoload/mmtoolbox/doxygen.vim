...
if s:Enabled == 1
	...
	command!       -nargs=0                DoxygenGenerateConfig :call <SID>GenerateConfig()
	command!       -nargs=0                DoxygenEditConfig     :call <SID>EditConfig()
	command!       -nargs=0                DoxygenViewLog        :call <SID>ViewLog()
